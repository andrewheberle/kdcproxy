...
```sh
go install github.com/andrewheberle/kdcproxy/cmd/kdcproxy@v1.4.0
...
```sh
docker run -p 8080:8080 ghcr.io/andrewheberle/kdcproxy:v1.4.0
```
...
docker run -p 8443:8080 \
    ...
    ghcr.io/andrewheberle/kdcproxy:v1.4.0
```
